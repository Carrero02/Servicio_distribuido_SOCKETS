 ...
 * Esta función se llama desde el servidor tras recibir una petición de un cliente.
 * 
 ...
 * de éxito y -1 en caso de error. También se devolverá -1 si el valor N_value2 está fuera
 * de rango.
 * Esta función se llama desde el servidor tras recibir una petición de un cliente.
 * 
 * @param key clave.
